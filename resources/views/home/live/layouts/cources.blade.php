@include('layouts.header')
 ...
 <div class="container py-4">
    ...
    <!-- Example 1: Simple Card Quote -->
    
    <!-- Example 2: Quotes Carousel -->
    <div id="quoteCarousel" class="carousel slide my-5" data-bs-ride="carousel">
      
        <h1 class="display-5 mb-4 text-center">Inspiring Quotes for Success</h1>
      <div class="carousel-inner">

        <div class="carousel-item active">
          <div class="quote-slide text-center">
            <blockquote class="blockquote">
              <p class="mb-2">“Success is not final, failure is not fatal: it is the courage to continue that counts.”</p>
              <footer class="blockquote-footer text-black fw-bold">Winston Churchill</footer>
            </blockquote>
          </div>
        </div>
        ...
        <div class="carousel-item">
          <div class="quote-slide text-center">
            <blockquote class="blockquote">
              <p class="mb-2">“Quality means doing it right when no one is looking.”</p>
              <footer class="blockquote-footer text-black fw-bold">Henry Ford</footer>
            </blockquote>
          </div>
        </div>
        ...
        <div class="carousel-item">
          <div class="quote-slide text-center">
            <blockquote class="blockquote">
              <p class="mb-2">“The best way to find yourself is to lose yourself in the service of others.”</p>
              <footer class="blockquote-footer text-black fw-bold">Mahatma Gandhi</footer>
            </blockquote>
          </div>
        </div>
      ...
      <div class="carousel-indicators">
        <button type="button" data-bs-target="#quoteCarousel" data-bs-slide-to="0" class="active" aria-current="true"></button>
        <button type="button" data-bs-target="#quoteCarousel" data-bs-slide-to="1"></button>
        <button type="button" data-bs-target="#quoteCarousel" data-bs-slide-to="2"></button>
      </div>
    </div>
 ...
 <div class="container-fluid about py-5">
        ...
        <div class="container-fluid service pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    ...
                    <h1 class="display-5 mb-4">My Cources </h1>
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-item">
                            ...
                            <div class="rounded-bottom p-4">
                                <a href="#" class="h4 d-inline-block mb-4"> Cources 1</a>
                                ...
                                <a class="btn btn-primary rounded-pill py-2 px-4" href="{{url('/')}}">Cources</a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- <div class="container-fluid service pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h4 class="text-primary">Our Test Series</h4>
                    <h1 class="display-5 mb-4">Test Series </h1>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="{{asset('frontend/img/service-2.jp')}}g" class="img-fluid rounded-top w-100" alt="Image">
                            </div>
                            <div class="rounded-bottom p-4">
                                <a href="#" class="h4 d-inline-block mb-4">Cources 2</a>
                                <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, sint? Excepturi facilis neque nesciunt similique officiis veritatis,
                                </p>
                                <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="service-item">
                            ...
                            <div class="rounded-bottom p-4">
                                <a href="#" class="h4 d-inline-block mb-4">Cources 3</a>
                                <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, sint? Excepturi facilis neque nesciunt similique officiis veritatis,
                                </p>
                                <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a>
                            </div>
        ...
        <div class="container-fluid service pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h4 class="text-primary">Our Classroom</h4>
                    <h1 class="display-5 mb-4">Classroom (LMS System)</h1>
        ...
        <!-- <div class="container-fluid service pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h4 class="text-primary">Our Notes</h4>
                    <h1 class="display-5 mb-4">All Notes</h1>
