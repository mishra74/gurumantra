    ...
    <div class="mb-3 col-md-6 custom" style="display:none">
        ...
        @error('validity') <small class="text-danger">{{ $message }}</small> @enderror
    ...
    <input type="number" class="form-control" name="mrp" value="{{old('mrp')}}" placeholder="MRP" >
   ...
   <div class="mb-3 col-md-2 fixed">
    <label for="inputEmail4" class="form-label">Price for  90 days</label>
    <input type="text" class="form-control" name="price_two" value="{{old('discount_two')}}" placeholder="discount for 90 days">
   ...
   <div class="mb-3 col-md-2 fixed">
    ...
    <input type="text" class="form-control" name="discount_four" value="{{old('mrp_four')}}" placeholder="Discount for 270 days" >
   ...
   <div class="mb-3 col-md-2 fixed">
    ...
    <input type="text" class="form-control" name="mrp_five" value="{{old('mrp_five')}}" placeholder="MRP for 360 days">
   ...
   <div class="mb-3 col-md-6">
    <label for="inputEmail4" class="form-label">Coin Percentage</label>
    <input type="number" class="form-control" name="coin_percentage" value="{{old('coin_percentage')}}" placeholder="0">
