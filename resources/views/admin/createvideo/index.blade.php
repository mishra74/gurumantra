...
<div class="wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ url('admin/recording_creates/add') }}" class="btn btn-primary mb-3">
    ...
    @endif
                                                ...
                                                <td>
                                                        <a href="{{ url('admin/tag/edit/'.$create->id) }}">
                                                            <i class="fa fa-edit text-success"></i>
                                                        </a>
                                                        <a href="{{ url('admin/tag/delete/'.$create->id) }}">
                                                            <i class="fa fa-trash text-danger"></i>
                                                        </a>
                                                        <a href="{{ url('admin/tag/restore/'.$create->id) }}">
                                                            <i class="fa fa-undo text-warning"></i>
                                                        </a>
                                                        <a href="{{ url('admin/tag/toggle/'.$create->id) }}">
