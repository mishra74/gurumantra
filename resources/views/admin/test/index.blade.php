...
@endphp
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ route('add.test') }}" class="btn btn-primary mb-3">
    ...
    <a href="{{ url('admin/test/edit/' . $tes->id) }}">
...
@else
    <a href="{{ url('admin/test/delete/'.$tes->id) }}"
       onclick="return confirm('Move to trash?')">
        <i class="fa fa-trash text-danger"></i>
    </a>
@endif
                                                        <a href="{{ url('admin/test/restore/'.$tes->id) }}">
                                                            <i class="fa fa-undo text-warning"></i>
                                                        </a>
                                                        <a href="{{ url('admin/test/toggle/'.$tes->id) }}">
