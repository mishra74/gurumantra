...
@endphp
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ route('add.offline.mocktest.volume') }}" class="btn btn-primary mb-3">
    ...
    <a href="{{ url('admin/offline/mocktest/volume/edit/' . $tes->id) }}">
        <i class="fa fa-edit text-success"></i>
    </a>
@endif
                                                        @if($tes->deleted_at)
    <a href="{{ route('mocktest.offline.delete.permanent.volume', $tes->id) }}"
       onclick="return confirm('Delete permanently?')">
        <i class="fa fa-trash text-danger"></i>
    </a>
@else
    <a href="{{ route('mocktest.offline.delete.volume',$tes->id) }}"
       onclick="return confirm('Move to trash?')">
        <i class="fa fa-trash text-danger"></i>
    </a>
@endif
                                                        <a href="{{ route('mocktest.offline.restore.volume', $tes->id) }}">
                                                            <i class="fa fa-undo text-warning"></i>
                                                        </a>
                                                        <a href="{{ route('mocktest.offline.toggle.volume', $tes->id) }}">
