                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{route('create_pdfnotes.store')}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row g-2">
...
<div class="mb-3 col-md-12">
    <div class="form-check">
        <input class="form-check-input" type="checkbox" id="isPaid" name="paid" value="1">
        <label class="form-check-label">Paid Notes</label>
    </div>
</div>
<div class="row g-2">
    <div class="mb-3 col-md-6 custom paidFields" style="display:none">
...
<div class="mb-3 col-md-6 paidFields" style="display:none">
