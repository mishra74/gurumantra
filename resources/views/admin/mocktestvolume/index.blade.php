...
@endphp
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ route('add.mock_test') }}" class="btn btn-primary mb-3">
    ...
    <a href="{{ url('admin/mock_test/edit/' . $tes->id) }}">
        <i class="fa fa-edit text-success"></i>
    </a>
@endif
                                                        @if($tes->deleted_at)
    <a href="{{ route('test.delete.permanent', $tes->id) }}"
       onclick="return confirm('Delete permanently?')">
        <i class="fa fa-trash text-danger"></i>
    </a>
@else
    <a href="{{ url('admin/mock_test/delete/'.$tes->id) }}"
       onclick="return confirm('Move to trash?')">
        <i class="fa fa-trash text-danger"></i>
    </a>
@endif
                                                        <a href="{{ url('admin/mock_test/restore/'.$tes->id) }}">
                                                            <i class="fa fa-undo text-warning"></i>
                                                        </a>
                                                        <a href="{{ url('admin/mock_test/toggle/'.$tes->id) }}">
