...
<div class="wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ route('add.pdfnotes') }}" class="btn btn-primary mb-3">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            @foreach($test as $key => $tes)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td><a class="btn btn-primary" href="{{url('admin/create_pdfnote/'.$tes->id)}}"><i class="fa fa-plus"></i></a></td>
    ...
    @endif
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('admin/pdfnotes/edit/'.$tes->id) }}">
                                                            <i class="fa fa-edit text-success"></i>
                                                        </a>
                                                        @endif
                                                         @if($tes->deleted_at)
    <a href="{{ route('pdfnotes.delete.permanent', $tes->id) }}"
       onclick="return confirm('Delete permanently?')">
        <i class="fa fa-trash text-danger"></i>
    </a>
@else
    <a href="{{ url('admin/pdfnotes/delete/'.$tes->id) }}"
       onclick="return confirm('Move to trash?')">
        <i class="fa fa-trash text-danger"></i>
    </a>
@endif
                                                        <a href="{{ url('admin/pdfnotes/restore/'.$tes->id) }}">
                                                            <i class="fa fa-undo text-warning"></i>
                                                        </a>
                                                        <a href="{{ url('admin/pdfnotes/toggle/'.$tes->id) }}">
