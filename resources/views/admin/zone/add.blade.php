                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Add zone</a></li>
                                        ...
                                        <form method="post" action="{{route('zone.store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="row g-2">
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="title" value="{{old('title')}}" placeholder="Enter Zone Title" required>
