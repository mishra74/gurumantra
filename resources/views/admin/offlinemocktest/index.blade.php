...
<div class="wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ url('admin/offline/mocktest/add') }}" class="btn btn-primary mb-3">
    ...
    @endif
                                                ...
                                                <td>
                                                        <a href="{{ url('admin/offline/mocktest/edit/'.$create->id) }}">
                                                            <i class="fa fa-edit text-success"></i>
                                                        </a>
                                                        <a href="{{ url('admin/offline/mocktest/delete/'.$create->id) }}">
                                                            <i class="fa fa-trash text-danger"></i>
                                                        </a>
                                                        <a href="{{ url('admin/offline/mocktest/restore/'.$create->id) }}">
                                                            <i class="fa fa-undo text-warning"></i>
                                                        </a>
                                                        <a href="{{ url('admin/offline/mocktest/toggle/'.$create->id) }}">
