                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">OffLine Mock Tests</a></li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{route('mocktest.offline.store')}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row g-2">
...
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" name="live_class" id="inlineRadio2" value="yes">
  <label class="form-check-label" for="inlineRadio2">Live Test +  Practice</label>
</div>
...
<input type="datetime-local" 
       ...
       name="last_time" 
       value="{{ old('last_time', isset($model->last_time) ? \Carbon\Carbon::parse($model->last_time)->format('Y-m-d\TH:i') : '') }}">
...
<label for="inputEmail4" class="form-label">PDF Upload Quetion</label>
...
@error('mrp_one') <small class="text-danger">{{ $message }}</small> @enderror
    ...
    <label for="inputEmail4" class="form-label">Content Upload Question</label>
