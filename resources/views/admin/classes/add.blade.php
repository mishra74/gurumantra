                                        ...
                                        <form method="post" action="{{route('class.store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="time" class="form-control" name="time" value="{{old('time')}}" placeholder="Title" required>
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    <label for="inputEmail4" class="form-label">Class Start Date</label>
                                                    <input type="date" class="form-control" name="start_date" value="{{old('start_date')}}" placeholder="Title" required>
    ...
    <select class="form-control select2" name="batches[]" multiple="multiple" required>
        @foreach($batches as $batch)
            <option value="{{ $batch->id }}"
                {{ (is_array(old('batches')) && in_array($batch->id, old('batches'))) ? 'selected' : '' }}>
                {{ $batch->title }}
            </option>
        @endforeach
    </select>
