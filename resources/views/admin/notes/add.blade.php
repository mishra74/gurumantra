                                        ...
                                        <form method="post" action="{{route('notes.store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="sub_title" value="{{old('sub_title')}}" placeholder="Sub Title" required>
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="file" class="form-control" name="thumbnail" placeholder="" accept=".png, .jpg, .jpeg" required>
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <select class="form-control" name="category" required>
                                                        <option value="daily">Daily Current Affairs</option>
                                                        <option value="vvi">VVI Current Affairs</option>
                                                    </select>
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <textarea type="text" class="form-control ckeditor" name="content" placeholder=""></textarea>
