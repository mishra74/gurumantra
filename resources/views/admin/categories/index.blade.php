                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ route('add.category') }}" class="btn btn-primary mb-3">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        <a href="{{ url('admin/category/edit/'.$tag->id) }}">
                                                            <i class="fa fa-edit text-success"></i>
                                                        </a>
                                                        <a href="{{ url('admin/category/delete/'.$tag->id) }}">
                                                            <i class="fa fa-trash text-danger"></i>
                                                        </a>
                                                        <!--<a href="{{ url('admin/category/restore/'.$tag->id) }}">-->
