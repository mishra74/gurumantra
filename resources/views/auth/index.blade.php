            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info" style="color:#6f1622 !important">Welcome back</h3>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="{{route('student.register')}}" class="text-info text-gradient font-weight-bold">Sign up</a><br>
                    <a href="{{route('student.forgoton')}}" class="text-info text-gradient font-weight-bold">Forgot Password</a>
