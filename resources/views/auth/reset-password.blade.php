            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info" style="color:#6f1622 !important">Reset Password</h3>
                ...
                <div class="card-body">
                  <form role="form" method="post" action="{{route('password.update')}}">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="password" class="form-control" placeholder="Enter Password" aria-label="Email" name="password">
