        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h4 class="text-primary">Our Recording</h4>
                    <h1 class="display-5 mb-4">See Your Best Recording Cource</h1>
                </div>
                <div class="row g-4">
            ...
            <div class="course-desc flex-grow-1">
                ...
                <a href="javascript:void(0)" 
                   ...
                   Read More
                                ...
                                <a class="btn btn-primary rounded-pill py-2 px-4" href="{{url('/video_valume/'.$test->id)}}">Learn More</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
